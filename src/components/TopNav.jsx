...
const TopNav = () => {
  ...
  return (
    <div ref={menuRef} className="flex fixed top-0 z-40 bg-white inset-x-0 w-full justify-between h-14 items-center px-4 transform transition-opacity duration-300">
